...
public class TurretSllide : MonoBehaviour
{
    Turret1 turret1;
    ...
    private void Update()
    {
        if (Input.touchCount > 0)
        {
            ...
            if (touch.phase == TouchPhase.Began)
            {
                ...
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.1"))
                {
                ...
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.2"))
                {
                    // Save the hit object for later use
                ...
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.3"))
                {
                    // Save the hit object for later use
                ...
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.4"))
                {
                    // Save the hit object for later use
                ...
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.5"))
                {
                    // Save the hit object for later use
                    hitObject5 = hit.collider.gameObject;
                    hitkey5 = true;
                }
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.6"))
                {
                    // Save the hit object for later use
                    hitObject6 = hit.collider.gameObject;
                    hitkey6 = true;
                }
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.7"))
                {
                    // Save the hit object for later use
                    hitObject7 = hit.collider.gameObject;
                    hitkey7 = true;
                }
                if (Physics.Raycast(ray, out hit) && hit.collider.CompareTag("Box1.8"))
                {
                    // Save the hit object for later use
                ...
                if (swipeDistance > minSwipeDistance)
                {
                    ...
                    if (Mathf.Abs(swipeDirection.x) > Mathf.Abs(swipeDirection.y))
                    {
                        ...
                        if (swipeDirection.x > 0)
                        {
                            ...
                            {
                                //hitObject1.transform.position += new Vector3(0f, 0f, 4f);
                                hitkey = false;
                            ...
                            //{
                            //    //hitObject2.transform.position += new Vector3(0f, 0f, 4f);
                            //    StartCoroutine(RightPos2());
                            //    hitkey2 = false;
                            //}
                            if (hitObject3 != null && hitkey3 == true)
                            {
                                //hitObject3.transform.position += new Vector3(0f, 0f, 4f);
                                StartCoroutine(RightPos3());
                                hitkey3 = false;
                            }
                            if (hitObject4 != null && hitkey4 == true)
                            {
                                //hitObject4.transform.position += new Vector3(0f, 0f, 4f);
                                StartCoroutine(RightPos4());
                                hitkey4 = false;
                            }
                            //if (hitObject5 != null && hitkey5 == true)
                            //{
                            //    hitObject5.transform.position += new Vector3(0f, 0f, 4f);
                            //    hitkey5 = false;
                            //}
                            //if (hitObject6 != null && hitkey6 == true)
                            //{
                            //    hitObject6.transform.position += new Vector3(0f, 0f, 4f);
                            //    hitkey6 = false;
                            //}
                            //if (hitObject7 != null && hitkey7 == true)
                            //{
                            //    hitObject7.transform.position += new Vector3(0f, 0f, 4f);
                            //    hitkey7 = false;
                            //}
                            if (hitObject8 != null && hitkey8 == true)
                            {
                                //hitObject8.transform.position += new Vector3(0f, 0f, 4f);
                                hitkey8 = false;
                        ...
                        else
                        {
                            ...
                            // Move the hit object to the left
                            //if (hitObject1 != null&&hitkey==true)
                            //{
                            //    hitObject1.transform.position += new Vector3(0f, 0f, -4f);
                            //    hitkey = false;
                            //    //StartCoroutine(LeftPos());
                            //}
                            //if (hitObject2 != null && hitkey2 == true)
                            //{
                            //    hitObject2.transform.position += new Vector3(0f, 0f, -4f);
                    ...
                    else
                    {
                        ...
                        if (swipeDirection.y > 0)
                        {
                            ...
                            //if (hitObject1 != null&&hitkey==true)
                            //{
                            //    hitObject1.transform.position += new Vector3(-4f, 0f, 0f);
                            //    //StartCoroutine(ForwardPos());

                            //}
                            if (hitObject2 != null && hitkey2 == true)
                            {
                                //hitObject2.transform.position += new Vector3(-4f, 0f, 0f);
                                hitkey2 = false;
                            ...
                            if (hitObject3 != null && hitkey3 == true)
                            {
                                //hitObject3.transform.position += new Vector3(-4f, 0f, 0f);
                                hitkey3 = false;
                            ...
                            //if (hitObject4 != null && hitkey4 == true)
                            //{
                            //    hitObject4.transform.position += new Vector3(-4f, 0f, 0f);
                            //    hitkey4 = false;

                            //}
                            if (hitObject5 != null && hitkey5 == true)
                            {
                                //hitObject5.transform.position += new Vector3(-4f, 0f, 0f);
                                hitkey5 = false;
                            ...
                            if (hitObject6 != null && hitkey6 == true)
                            {
                                //hitObject6.transform.position += new Vector3(-4f, 0f, 0f);
                                hitkey6 = false;
                            ...
                            //if (hitObject7 != null && hitkey7 == true)
                            //{
                            //    hitObject7.transform.position += new Vector3(-4f, 0f, 0f);
                            //    hitkey7 = false;

                            //}
                            //if (hitObject8 != null && hitkey8 == true)
                            //{
                            //    hitObject8.transform.position += new Vector3(-4f, 0f, 0f);
                            //    hitkey8 = false;
    ...
    //IEnumerator RightPos2()
    //{
    //    Rightkey
    //    ObjeInitPos = hitObject2.transform.position;
    //    hitObject2.transform.position += new Vector3(0f, 0f, 9f);
    //    yield return new WaitForSeconds(0.5f);
